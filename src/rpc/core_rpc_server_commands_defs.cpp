...
KV_SERIALIZE_MAP_CODE_BEGIN(GET_SERVICE_NODES::requested_fields_t)
  ...
  if (!this_ref.all)
  {
    ...
    KV_SERIALIZE(worktipsnet_version)
    ...
    KV_SERIALIZE(worktipsnet_reachable)
    KV_SERIALIZE(worktipsnet_first_unreachable)
    KV_SERIALIZE(worktipsnet_last_unreachable)
    KV_SERIALIZE(worktipsnet_last_reachable)
...
KV_SERIALIZE_MAP_CODE_BEGIN(GET_SERVICE_NODES::response::entry)
  ...
  KV_SERIALIZE_ENTRY_FIELD_IF_REQUESTED(worktipsnet_version)
  ...
  KV_SERIALIZE_ENTRY_FIELD_IF_REQUESTED(worktipsnet_reachable);
  KV_SERIALIZE_ENTRY_FIELD_IF_REQUESTED(worktipsnet_first_unreachable)
  KV_SERIALIZE_ENTRY_FIELD_IF_REQUESTED(worktipsnet_last_unreachable)
  KV_SERIALIZE_ENTRY_FIELD_IF_REQUESTED(worktipsnet_last_reachable)
