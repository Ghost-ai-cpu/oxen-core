...
filenames=(dist/electron/Packaged/worktips-electron-wallet-*)
...
upload_to="worktips.rocks/${DRONE_REPO// /_}/${branch_or_tag// /_}"
...
sftp -i ssh_key -b - -o StrictHostKeyChecking=off drone@worktips.rocks <<SFTP
$sftpcmds
SFTP
