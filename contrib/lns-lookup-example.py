...
name = "Blocks.worktips"
type = 2 # 2 == worktipsnet, 0 == session

# Calculate the blake2b hash of the lower-case full name (including the .worktips):
...
r = requests.post('http://public.worktips.foundation:22023/json_rpc',
